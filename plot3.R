# plot3.R creates a line plot of the 3 Energy sub metering for the days of of Feb 1-2, 2007
...
plot3 <- function() {
    ...
    # Plot the three Sub metering values versus time to a PNG graphic device
